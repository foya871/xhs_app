...
class MessageLikesCollectionPage
    extends GetView<MessageLikesCollectionPageController> {
  const MessageLikesCollectionPage({super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flex(
                        ...
                        children: [
                          TextView(
                            text: model.informationType == 6
                                ? "点赞了你的"
                                : model.informationType == 12
                                    ? "收藏了你的"
                                    : "",
