...
class EdituserNamePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const EditUserNameChild(),
    );
  }
}

class EditUserNameChild extends StatefulWidget {
  const EditUserNameChild({super.key});

  @override
  State<StatefulWidget> createState() => EditUserNameChildState();
}

class EditUserNameChildState extends State<EditUserNameChild> {
  ...
  void onSaveClick() {
    ...
    controller.postModifyInfo(name: contentController.text);
  }
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: '${controller.userInfo.nickName}',
                      helperText: '名字30天内可修改1次，名字最多8个字',
                      hintStyle: TextStyle(
