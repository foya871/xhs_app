...
class _ProductDetailPageState extends State<ProductDetailPage> {
  final ProductDetailLogic logic =
      Get.put(ProductDetailLogic(), tag: "${Get.arguments}");
  final ProductDetailState state =
      Get.find<ProductDetailLogic>(tag: "${Get.arguments}").state;
  ...
  @override
  void dispose() {
    Get.delete<ProductDetailLogic>(tag: "${Get.arguments}");
    super.dispose();
  }
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  flex: 5,
                  child: GestureDetector(
                    onTap: () => logic.productLike(state.productDetail.value.isLike == true),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Obx(() {
