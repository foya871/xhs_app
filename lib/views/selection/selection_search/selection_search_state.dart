...
class SelectionSearchState {
  ...
  var guessLike = RxList<DynamicHotWordModel>.empty(growable: true);
  ...
  // ];
  var tabs = RxList<ProductClassifyModel>.empty(growable: true);

  var pages = RxList<Widget>.empty(growable: true);
  var refreshList = List<BaseRefreshController>.empty(growable: true);
