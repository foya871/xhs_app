...
class SearchPreviewWidgetState extends State<SearchPreviewWidget> {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
              ...
              return Wrap(
                ...
                children: state.guessLike.map((item) {
                  return buildGuessLikeItem(item, () {
                    logic.textController.text = item.title ?? "";
                    logic.onSearch(logic.textController.text);
                  });
                }).toList(),
              );
          ...
          // Container(
          //   margin: EdgeInsets.symmetric(horizontal: 14.w),
          //   child: Image.asset(AppImagePath.selection_ic_recent_hot,height: 15.h,),
          // ),
          // SizedBox(height: 5.h,),
          // Obx(() {
          ...
          //     separatorBuilder: (_,index)=> Divider(height: 1.h,color: ColorX.color_eeeeee,indent: 14.w,endIndent: 14.w,),
  ...
  Widget buildGuessLikeItem(DynamicHotWordModel item, Function() onTap) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        width: 150.w,
  ...
  //       child: Row(
  //         children: [
  //           Text("${index+1}",style: TextStyle(fontSize: 14.w,color: color,fontWeight: FontWeight.w500),),
  //           SizedBox(width: 20.w,),
  //           Expanded(
  //             child: Text(item.title ?? '',style: TextStyle(fontSize: 14.w,color: ColorX.color_333333),maxLines: 1,overflow: TextOverflow.ellipsis,),
  //           ),
  //           Text("${item.fakeWatchTimes ?? 0}观看",style: TextStyle(fontSize: 12.w,color: ColorX.color_999999),),
  //         ],
  //       ),
  //     ),
  //   );
