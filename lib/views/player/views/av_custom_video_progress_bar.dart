...
class AvCustomVideoProgressBar extends StatefulWidget {
  AvCustomVideoProgressBar(
    this.controller, {
  ...
  final ValueCallback<Duration>? onDragUpdate;
...
class _VideoProgressBarState extends State<AvCustomVideoProgressBar> {
  void listener() {
    if (!mounted) return;
    setState(() {});
  }
  ...
  void _seekToRelativePosition(Offset globalPosition) {
    controller
        .seekTo(context.calcRelativePosition(
    ...
    return widget.draggableProgressBar
        ? GestureDetector(
            ...
            onHorizontalDragUpdate: (DragUpdateDetails details) {
              ...
              listener();
              final current = context.calcRelativePosition(
                controller.value.duration,
                _latestDraggableOffset!,
              );
              widget.onDragUpdate?.call(current);
            },
