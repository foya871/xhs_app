...
class ComicsBookModel {
  ...
  Map<String, dynamic> toJson() {
    return Map<String, dynamic>()
      ...
      ..put('firstChapterId', this.firstChapterId);
  }

  ComicsBookModel.fromJson(Map<String, dynamic> json) {
    this.authorName = json.asString('authorName');
    this.backImg = json.asString('backImg');
    this.chapterList = json.asList<ChapterList>('chapterList',
        (v) => ChapterList.fromJson(Map<String, dynamic>.from(v)));
    ...
    this.firstChapterId = json.asInt('firstChapterId');
  }

  static ComicsBookModel toBean(Map<String, dynamic> json) =>
      ComicsBookModel.fromJson(json);
}
